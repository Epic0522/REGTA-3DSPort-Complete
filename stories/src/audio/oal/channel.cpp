...
void CChannel::Start()
{
	...
	{
#ifdef _3DS
		/* The 3DS mixer is mono. Uploading the source PCM directly avoids a
		 * per-playback stereo copy and, more importantly, the fixed 79 kB
		 * scratch buffer that large LCS samples could overrun. */
