...
#ifdef _3DS
/* 3DS input bypasses the configurable desktop joystick table.  Resolve every
 * ~k~ help token to the labels physically printed on the console, using plain
 * text so no PlayStation icon atlas can leak into gameplay hints. */
#undef UP
#undef DOWN
#undef LEFT
#undef RIGHT
