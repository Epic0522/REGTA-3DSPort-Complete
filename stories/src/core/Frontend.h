...
#ifdef _3DS
#define BIGTEXT2_X_SCALE 0.69f // For FONT_STANDARD
#define BIGTEXT2_Y_SCALE 1.38f
#define BIGTEXT_X_SCALE 0.69f // For FONT_HEADING
#define BIGTEXT_Y_SCALE 1.15f
#define MEDIUMTEXT_X_SCALE 0.55f // For FONT_STANDARD
#define MEDIUMTEXT_Y_SCALE 1.15f
#define SMALLTEXT_X_SCALE 0.48f // For FONT_STANDARD
#define SMALLTEXT_Y_SCALE 1.04f
#define SMALLESTTEXT_X_SCALE 0.35f // For FONT_STANDARD
#define SMALLESTTEXT_Y_SCALE 0.81f
#else
