...
#if __NEWLIB__ >= 4
/*
 * Newer devkitARM/newlib releases replaced the writable __syscalls table
 * with weak __syscall_* entry points.  Keep the bundled 2021 libctru usable
 * without changing its runtime behaviour or pulling in a different libctru.
 */
