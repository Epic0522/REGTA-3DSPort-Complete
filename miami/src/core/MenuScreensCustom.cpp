...
void RestoreDefGraphics(int8 action) {
	if (action != FEOPTION_ACTION_SELECT)
		...
		#endif
		FrontEndMenuManager.m_PrefsUseWideScreen = AR_5_4;
...
CMenuScreenCustom aScreens[] = {
	...
	{ "FEM_MM", MENUPAGE_DISABLED, nil, nil,
		  MENUACTION_CHANGEMENU,	"FEP_STG",	{nil, SAVESLOT_NONE,	MENUPAGE_NEW_GAME}, 320, 185, MENUALIGN_CENTER,
	...
	{ "FET_PAU", MENUPAGE_DISABLED, nil, nil,
		MENUACTION_RESUME,		"FEP_RES",	{nil, SAVESLOT_NONE, 0}, 320, 135, MENUALIGN_CENTER,
