...
#ifdef _3DS
#define BIGTEXT2_X_SCALE 0.65f // For FONT_STANDARD
#define BIGTEXT2_Y_SCALE 1.3f
#define BIGTEXT_X_SCALE 0.65f // For FONT_HEADING
#define BIGTEXT_Y_SCALE 1.08f
#define MEDIUMTEXT_X_SCALE 0.52f // For FONT_STANDARD
#define MEDIUMTEXT_Y_SCALE 1.08f
#define SMALLTEXT_X_SCALE 0.45f // For FONT_STANDARD
#define SMALLTEXT_Y_SCALE 0.97f
#define SMALLESTTEXT_X_SCALE 0.32f // For FONT_STANDARD
#define SMALLESTTEXT_Y_SCALE 0.76f
#else
