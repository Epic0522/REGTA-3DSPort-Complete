...
void ShutdownBottomRadar(void);
#endif
void PreAllocateRwObjects(void);
void InitialiseGame(void);
void LoadingScreen(const char *str1, const char *str2, const char *splashscreen);
void SetLoadingScreenProgress(float progress);
void SetLoadingScreenStage(float progress, const char *detail);
void BeginLoadingScreenProgressRange(float start, float end);
void UpdateLoadingScreenProgressRange(float progress);
void EndLoadingScreenProgressRange(void);
