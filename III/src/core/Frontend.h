...
#ifdef _3DS
#define BIGTEXT_X_SCALE 0.81f // For FONT_HEADING
#define BIGTEXT_Y_SCALE 0.97f
#define MEDIUMTEXT_X_SCALE 0.59f // For FONT_HEADING
#define MEDIUMTEXT_Y_SCALE 0.86f
#define SMALLTEXT_X_SCALE 0.49f // used for FONT_HEADING and FONT_BANK, but looks off for HEADING
#define SMALLTEXT_Y_SCALE 0.76f
#define SMALLESTTEXT_X_SCALE 0.43f // used for both FONT_HEADING and FONT_BANK
#define SMALLESTTEXT_Y_SCALE 0.65f
#else
